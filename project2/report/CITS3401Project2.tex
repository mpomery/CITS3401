...
This means that each different category is seperated by as large a gap as possible.
...
\paragraph \indent
Neural Networks are based off of animal's central nervous systems, by using several input sensors that transform the data before hadning it on to another neuron.
The neurons are connected together in a network and work simultaneously , rather then sequentually, to process the data.
Real world applications for nueral networks include speach and hadnwriting recognition.
