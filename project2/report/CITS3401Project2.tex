...
In the white wine dataset, ignoring different combinations of attributes had very little effect on the clustering and so it did not seem possible to cluster the data points into a similar distrubution to the initial data.
...
Dataset 2's results were ignored when analysing the performance of the different classifiers.
...
This makes classification hard as there is very little vairance in the data.
...
\paragraph \indent
The nueral network classifier gives the best classification rate for dataset 1, and a similar classification as the support vector machine classifier for dataset 2.
